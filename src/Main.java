...
public class Main {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        if (characterToUpdate != null) {
                            ...
                            System.out.println("Is the character alive? (true/false):");
                            boolean newAlive = Boolean.parseBoolean(scanner.nextLine());
                    ...
                    case 4:
                        ...
                        deleteCharacter(characterManager, deleteIdentifier);
     ...
     * @param characterManager adds characters.
    ...
    /**
     * clear the database.
     * @param characterManager clear characters.
     */
     ...
     * @param characterManager retrieve characters.
     */
     ...
     * @param characterManager retrieves characters.
     * @param identifier name or number of the character.
     ...
     * @param characterManager delete characters.
     * @param identifier name or number of the character to delete.
     */
    static void deleteCharacter(CharacterManager characterManager, String identifier) {
        if (identifier.matches("\\d+")) {
     ...
     * @param characterManager used to retrieve characters from.
